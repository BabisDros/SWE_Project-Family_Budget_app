...
Το παρόν έγγραφο εξυπηρετεί τους εξής σκοπούς:
1.  Ορισμός των απαιτήσεων της εφαρμογής Budgeting
2.  Ανάλυση των απαιτήσεων 

## Εμβέλεια

Η εφαρμογή θα αναπτυχθεί για συσκευές android με σκοπό την καταγραφή  και υπολογισμό εσόδων και εξόδων ανεξάρτητα ή βάσει κάποιου προϋπολογισμού με δυνατότητα απεικόνισης σχετικών στατιστικών. 
